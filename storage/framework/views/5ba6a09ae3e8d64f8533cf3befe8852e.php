...
<div class="att-wrap">
    ...
    <div class="att-top">
        ...
        <div class="att-clock">
            ...
            <div class="att-clock-date"><?php echo e(now()->format('l, F j Y')); ?></div>
            ...
            <div class="att-input-body" id="input-body">
                ...
                <div id="input-active" style="display:none;flex-direction:column;gap:8px;flex:1">
                    ...
                    <div class="pin-wrap">
                        ...
                        <div class="pin-grid">
                            <?php $__currentLoopData = [1,2,3,4,5,6,7,8,9]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="pin-key" data-val="<?php echo e($n); ?>"><?php echo e($n); ?></button>
    ...
    <div class="att-table-wrap">
        <div class="att-table-header">
            <span style="font-size:13px;font-weight:600;color:var(--text)">Today's Logs — <?php echo e(now()->format('F j, Y')); ?></span>
            <form method="GET" style="display:flex;gap:8px;align-items:center">
                ...
                <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-outline btn-sm">Today</a>
            </form>
        </div>
                    ...
                    <tr style="border-bottom:1px solid rgba(26,18,8,0.05)">
                        <td style="padding:10px 14px">
                            <div style="display:flex;align-items:center;gap:8px">
                                ...
                                <strong style="font-size:13px"><?php echo e($log->employee->full_name); ?></strong>
                            </div>
                        </td>
                        <td style="padding:10px 14px;font-weight:500"><?php echo e($log->time_in   ? $log->time_in->format('h:i A')   : '—'); ?></td>
                        <td style="padding:10px 14px"><?php echo e($log->break_out ? $log->break_out->format('h:i A') : '—'); ?></td>
                        <td style="padding:10px 14px"><?php echo e($log->break_in  ? $log->break_in->format('h:i A')  : '—'); ?></td>
                        <td style="padding:10px 14px;font-weight:500"><?php echo e($log->time_out  ? $log->time_out->format('h:i A')  : '—'); ?></td>
                        <td style="padding:10px 14px"><?php echo e($log->total_hours_worked > 0 ? $log->total_hours_worked.'h' : '—'); ?></td>
                        <td style="padding:10px 14px">
                            <?php if($log->overtime_hours > 0): ?>
                                <span style="color:var(--accent);font-weight:600">+<?php echo e($log->overtime_hours); ?>h</span>
                            <?php else: ?> —
                            <?php endif; ?>
                        </td>
                        <td style="padding:10px 14px">
                            <?php if($log->is_late): ?>
                                <span class="badge badge-rejected"><?php echo e($log->late_minutes); ?>m late</span>
                            <?php else: ?>
...
const ROUTES    = {
    'time-in':   '<?php echo e(route("attendance.time-in")); ?>',
    'break-out': '<?php echo e(route("attendance.break-out")); ?>',
    'break-in':  '<?php echo e(route("attendance.break-in")); ?>',
    'time-out':  '<?php echo e(route("attendance.time-out")); ?>',
    'pin-clock': '<?php echo e(route("attendance.pin-clock")); ?>',
};
const ATT_URL   = '<?php echo e(url("/attendance")); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Cornelia\resources\views/attendance/index.blade.php ENDPATH**/ ?>