...
<form method="POST" action="<?php echo e(route('employees.store')); ?>" id="employeeForm">
<?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="last_name" id="last_name" class="form-control"
                               value="<?php echo e(old('last_name')); ?>" required placeholder="e.g. Dela Cruz">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" id="first_name" class="form-control"
                               value="<?php echo e(old('first_name')); ?>" required placeholder="e.g. Juan">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="middle_name" class="form-control"
                               value="<?php echo e(old('middle_name')); ?>" placeholder="Optional">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display:flex;align-items:center">
                            ...
                            <input type="text" name="phone" class="form-control"
                                   value="<?php echo e(old('phone')); ?>" placeholder="9XX XXX XXXX"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control"
                           value="<?php echo e(old('address')); ?>" placeholder="Street, Barangay, City, Province">
                </div>
                <div class="form-group">
                    <label class="form-label">Emergency Contact Name</label>
                    <input type="text" name="emergency_contact_name" class="form-control"
                           value="<?php echo e(old('emergency_contact_name')); ?>" placeholder="Full name">
                </div>
                <div class="form-group" style="margin-bottom:0">
                    ...
                    <div style="display:flex;align-items:center">
                        ...
                        <input type="text" name="emergency_contact_number" class="form-control"
                               value="<?php echo e(old('emergency_contact_number')); ?>" placeholder="9XX XXX XXXX"
                               maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'')"
                               style="border-radius:0 var(--radius-sm) var(--radius-sm) 0;border-left:none">
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="employee_no" id="employee_no" class="form-control"
                               value="<?php echo e(old('employee_no','CSB-')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="employment_type" class="form-control" required>
                            ...
                            <option value="contractual" <?php echo e(old('employment_type')=='contractual' ?'selected':''); ?>>Contractual</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="pay_type" name="pay_type" class="form-control">
                            <option value="monthly"      <?php echo e(old('pay_type','monthly')=='monthly'     ?'selected':''); ?>>Monthly Pay</option>
                            <option value="semi_monthly" <?php echo e(old('pay_type')=='semi_monthly'          ?'selected':''); ?>>Semi-Monthly</option>
                            <option value="daily"        <?php echo e(old('pay_type')=='daily'                 ?'selected':''); ?>>Daily Rate</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-label" id="pay-label">Monthly Pay (₱) *</label>
                        <input type="number" step="0.01" id="pay_amount" name="pay_amount"
                               class="form-control" value="<?php echo e(old('pay_amount')); ?>"
                ...
                <div style="background:#faf8f5;border-radius:8px;padding:14px;border:1px solid var(--border);margin-top:4px">
                    ...
                    <input type="hidden" name="daily_rate" id="daily_rate" value="<?php echo e(old('daily_rate','0')); ?>">
                </div>
            </div>
        </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="sss_no" class="form-control"
                               value="<?php echo e(old('sss_no')); ?>" placeholder="XX-XXXXXXX-X"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="philhealth_no" class="form-control"
                               value="<?php echo e(old('philhealth_no')); ?>" placeholder="XXXX-XXXXXXX-X"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pagibig_no" class="form-control"
                               value="<?php echo e(old('pagibig_no')); ?>" placeholder="XXXX-XXXX-XXXX"
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <input type="text" name="tin_no" class="form-control"
                               value="<?php echo e(old('tin_no')); ?>" placeholder="XXX-XXX-XXX"
                ...
                <div class="form-grid">
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <input type="text" name="username" class="form-control"
                               value="<?php echo e(old('username')); ?>" placeholder="e.g. jdelacruz"
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        ...
                        <div style="display:flex;gap:8px">
                            <input type="text" name="password" id="emp_password" class="form-control"
                                   value="<?php echo e(old('password')); ?>" placeholder="Min. 6 characters" required>
    ...
    <div style="display:flex;flex-direction:column;gap:16px;position:sticky;top:72px">
            ...
            <div class="card-body" style="padding:14px">
                ...
                <div class="form-group">
                    ...
                    <div style="display:flex;gap:8px">
                        <input type="text" name="biometric_pin" id="biometric_pin" class="form-control"
                               value="<?php echo e(old('biometric_pin')); ?>" placeholder="4–6 digits" maxlength="6"
                ...
                <div class="form-group" style="margin-bottom:12px">
                    ...
                    <input type="text" name="biometric_id" id="biometric_id" class="form-control"
                           value="<?php echo e(old('biometric_id')); ?>" placeholder="Auto-filled on scan">
                </div>
                ...
                <input type="hidden" name="webauthn_credential_id" id="webauthn_credential_id" value="<?php echo e(old('webauthn_credential_id')); ?>">
                <input type="hidden" name="biometric_enrolled"     id="biometric_enrolled"     value="<?php echo e(old('biometric_enrolled','0')); ?>">
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body" style="padding:14px">
                ...
                <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-outline"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Cornelia\resources\views/employees/create.blade.php ENDPATH**/ ?>