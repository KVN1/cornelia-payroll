...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Cornelia Street Bistro'); ?> — Payroll</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('auth.password-requests')); ?>" class="nav-link <?php echo e(request()->routeIs('auth.password-requests') ? 'active' : ''); ?>">
            <span class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
            ...
            Password Requests
            <?php $pendingPwCount = \App\Models\PasswordChangeRequest::where('status','pending')->count(); ?>
            <?php if($pendingPwCount > 0): ?>
                <span style="margin-left:auto;background:var(--red);color:#fff;font-size:10px;font-weight:700;padding:2px 7px;border-radius:20px"><?php echo e($pendingPwCount); ?></span>
            <?php endif; ?>
        </a>
        <a href="<?php echo e(route('settings')); ?>" class="nav-link <?php echo e(request()->routeIs('settings*') ? 'active' : ''); ?>">
            <span class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
...
<div class="main-wrap">
    <div class="topbar">
        <div class="topbar-left">
            <div class="topbar-title" id="page-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></div>
        </div>
        <div class="topbar-right">
            <div class="topbar-name"><?php echo e(auth()->user()->name ?? 'User'); ?></div>
            <div class="topbar-avatar"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'U', 0, 2))); ?></div>
...
<?php /**PATH D:\xampp\htdocs\Cornelia\resources\views/layouts/app.blade.php ENDPATH**/ ?>