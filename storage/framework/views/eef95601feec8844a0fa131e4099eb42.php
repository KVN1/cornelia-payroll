...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:28px">
    <div>
        ...
        <div style="font-size:14px;color:var(--text2);margin-top:4px">
            <?php echo e(now()->format('l, F j Y')); ?> · Cornelia Street Bistro
        </div>
    </div>
...
<div class="stats-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:20px">
    ...
    <div class="stat-card green" onclick="window.location='<?php echo e(route('employees.index')); ?>'" style="cursor:pointer">
    ...
    <div class="stat-card blue" onclick="window.location='<?php echo e(route('attendance.index')); ?>'" style="cursor:pointer">
        ...
        <div class="stat-value"><?php echo e($presentToday); ?></div>
        <div class="stat-sub">timed in</div>
    </div>

    <div class="stat-card red" onclick="window.location='<?php echo e(route('attendance.index')); ?>'" style="cursor:pointer">
        ...
        <div class="stat-value" style="color:var(--red)"><?php echo e($absentToday); ?></div>
        <div class="stat-sub">no log today</div>
    </div>

    <div class="stat-card orange" onclick="window.location='<?php echo e(route('leaves.index')); ?>'" style="cursor:pointer">
        ...
        <div class="stat-value"><?php echo e($pendingLeaves); ?></div>
        <div class="stat-sub">awaiting approval</div>
    </div>

    <div class="stat-card" onclick="window.location='<?php echo e(route('payroll.index')); ?>'" style="cursor:pointer">
        ...
        <div class="stat-value"><?php echo e($openPayrolls); ?></div>
...
<div class="card" style="padding:18px 22px;margin-bottom:20px">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
        ...
        <span style="font-size:14px;font-weight:700;color:var(--green)">
            <?php echo e(round(($presentToday / $totalEmployees) * 100)); ?>%
        </span>
    </div>
    <div style="background:#f0ede8;border-radius:20px;height:8px;overflow:hidden">
        <div style="height:100%;width:<?php echo e(round(($presentToday / $totalEmployees) * 100)); ?>%;background:linear-gradient(to right,var(--green),#52b788);border-radius:20px;transition:width 1s ease"></div>
    </div>
    <div style="display:flex;justify-content:space-between;margin-top:8px;font-size:11.5px;color:var(--text2)">
        <span><?php echo e($presentToday); ?> present</span>
        <span><?php echo e($absentToday); ?> absent</span>
        <span><?php echo e($totalEmployees); ?> total</span>
    </div>
</div>
<?php endif; ?>
    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div style="font-size:12px;color:var(--text2);margin-top:2px"><?php echo e(now()->format('M d, Y')); ?></div>
            </div>
            <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-outline btn-sm">View All</a>
        </div>
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $todayLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div style="display:flex;align-items:center;gap:10px">
                                <div style="width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;flex-shrink:0">
                                    <?php echo e(strtoupper(substr($log->employee->first_name,0,1).substr($log->employee->last_name,0,1))); ?>

                                </div>
                                <div>
                                    <div style="font-weight:600;font-size:13px"><?php echo e($log->employee->full_name); ?></div>
                                    <div style="font-size:11.5px;color:var(--text2)"><?php echo e($log->employee->position->title); ?></div>
                                </div>
                            </div>
                        </td>
                        <td style="font-size:13px;font-weight:500"><?php echo e($log->time_in ? $log->time_in->format('h:i A') : '—'); ?></td>
                        <td>
                            <?php if($log->break_out && !$log->break_in): ?>
                                <span class="badge badge-pending">On Break</span>
                            <?php elseif($log->break_in): ?>
                    ...
                    <tr>
                        <td colspan="4" style="text-align:center;padding:36px 24px">
                            ...
                            <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-accent btn-sm" style="margin-top:12px;display:inline-flex">Go to Attendance</a>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div style="font-size:12px;color:var(--text2);margin-top:2px"><?php echo e($pendingLeaves); ?> awaiting approval</div>
            </div>
            <a href="<?php echo e(route('leaves.index')); ?>" class="btn btn-outline btn-sm">View All</a>
        </div>
        <div class="table-wrap">
            <table>
                <thead>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $pendingLeavesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <div style="display:flex;align-items:center;gap:10px">
                                <div style="width:30px;height:30px;border-radius:50%;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;flex-shrink:0">
                                ...
                                <strong style="font-size:13px"><?php echo e($leave->employee->full_name); ?></strong>
                            </div>
                        </td>
                        <td>
                        ...
                        <td style="font-size:12.5px;color:var(--text2)">
                            <?php echo e($leave->date_from->format('M d')); ?> – <?php echo e($leave->date_to->format('M d')); ?>

                        </td>
                        <td>
                            <div style="display:flex;gap:5px">
                                <form method="POST" action="<?php echo e(route('leaves.approve', $leave)); ?>" style="display:inline">
                                    <?php echo csrf_field(); ?>
                                    <button class="btn btn-success btn-xs" title="Approve">
                                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
                                    </button>
                                </form>
                                <form method="POST" action="<?php echo e(route('leaves.reject', $leave)); ?>" style="display:inline">
                                    <?php echo csrf_field(); ?>
...
<div style="margin-top:20px;background:var(--sidebar);border-radius:var(--radius);padding:20px 24px;display:flex;align-items:center;justify-content:space-between;gap:16px">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
        <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-sm" style="background:rgba(255,255,255,0.07);color:rgba(255,255,255,0.8);border:1px solid rgba(255,255,255,0.1);gap:7px">
        ...
        <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-sm" style="background:rgba(200,132,74,0.2);color:var(--gold);border:1px solid rgba(200,132,74,0.3);gap:7px">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            Attendance
        </a>
        <a href="<?php echo e(route('leaves.create')); ?>" class="btn btn-sm" style="background:rgba(255,255,255,0.07);color:rgba(255,255,255,0.8);border:1px solid rgba(255,255,255,0.1);gap:7px">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            File Leave
        </a>
        <a href="<?php echo e(route('payroll.create')); ?>" class="btn btn-sm" style="background:rgba(45,106,79,0.25);color:#6ee7b7;border:1px solid rgba(45,106,79,0.4);gap:7px">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\Cornelia\resources\views/dashboard.blade.php ENDPATH**/ ?>